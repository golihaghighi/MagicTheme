...
/** 
 * A class that initializes Magic Container
 * @author Afshin
 * @version 1.0
 * @package MagicFramework
 */
class MagicContainer implements iMagicLayoutNode, iMagicRender {
	...
	public function render( $factory ) {
		...
		?>
<div class="magicf-page-form-container-holder"
	id="magicf_<?php echo esc_attr($this->name); ?>"
